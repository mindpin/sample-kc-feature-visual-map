...
(function() {
  var DATA_JS_JSON_URL, FIXTRUE_GRAPH_JSON_URL, do_test;
  ...
  jQuery(function() {
    jQuery.getJSON(FIXTRUE_GRAPH_JSON_URL, function(obj) {
      return do_test(obj['G1'], obj['G2'], obj['G3'], obj['G4']);
    });
    return jQuery.getJSON(DATA_JS_JSON_URL, function(obj) {
      var js_net;
